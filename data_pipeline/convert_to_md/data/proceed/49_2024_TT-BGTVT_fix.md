...
_Theo đề nghị của Vụ trưởng Vụ Khoa học - Công nghệ và Môi trường và Cục trưởng Cục Đường bộ Việt Nam;_

_Bộ trưởng Bộ Giao thông vận tải ban hành Thông tư ban hành Quy chuẩn kỹ thuật quốc gia về Trung tâm sát hạch lái xe cơ giới đường bộ._
...
_1.3.2._ Dữ liệu kết quả sát hạch _:_ là kết quả các nội dung sát hạch được Phần mềm quản lý sát hạch tổng hợp theo thời gian thực từ các máy chủ sát hạch.
...
|Thông số kích thước|Hạng A1|Hạng A| |---|---|---| |Bán kính vòng ngoài R1|3,0|3,4| |Bán kính vòng trong và bán kính điểm uốn nối tiếp giữa hai vòng<br>tròn ngoài Ro|2,3|2,5| |Khoảng cách tâm giữa hai vòng tròn trong OO’|5,7|6,3| |Khoảng cách tâm giữa vòng tròn trong và vòng uốn nối tiếp OO” =<br>O’O”|5,3|5,9|
...
|Col1|Col2|Kích|thước tính bằng mét| |---|---|---|---| |Thông số kích thước|Ký hiệu|Hạng A1|Hạng A| |Chiều dài|Lt|18,0|27| |Chiều rộng|Bt|0,6|0,6| |Màu sơn||Trắng|Trắng|
...
|Thông số kích thước|Hạng A1|Hạng A| |---|---|---| |Chiều dài đoạn đường có vạch cản (Lt)|18,0|27,0| |Khoảng cách giữa các vạch cản|4,5|4,5| |Chiều rộng làn đường có vạch cản|3,0|3,0| |Chiều dài vạch cản|1,5|1,5| |Chiều rộng vạch cản|0,1|0,1| |Màu sơn vạch cản|Trắng|Trắng|
...
|Thông số kích thước|Hạng A1|Hạng A| |---|---|---| |Chiều dài đoạn đường gồ ghề|15,0|15,0| |Chiều dài dải gồ ghề|0,9|0,9| |Chiều rộng đế dải gồ ghề|0,2|0,2| |Chiều rộng đỉnh dải gồ ghề|0,1|0,1| |Chiều cao dải gồ ghề|0,05|0,05| |Khoảng cách giữa các dải gồ ghề|1,5|1,7| |Vật liệu dải gồ ghề|Cứng, không đàn hồi|Cứng, không đàn hồi| |Màu sơn trên mặt dải gồ ghề|Trắng|Trắng|
...
2.2.2. Xe sát hạch hạng A1: là xe mô tô hai bánh, có dung tích xi-lanh từ 70 cm [3] đến 125 cm [3] hoặc có công suất động cơ điện từ 6 đến 11 kW.

2.2.3. Xe sát hạch hạng A: là xe mô tô hai bánh, có dung tích làm việc của xy lanh trên 200 cm [3] hoặc có công suất động cơ điện trên 11 kW.

2.2.4. Xe sát hạch hạng B1: là xe mô tô ba bánh, có dung tích làm việc của xy lanh từ 105 cm [3] trở lên, có số lùi, có chiều dài toàn bộ không lớn hơn 3,0 m, chiều rộng toàn bộ không lớn hơn 1,5 m, chiều dài cơ sở không lớn hơn 2,3 m, bán kính quay vòng nhỏ nhất theo vệt bánh xe trước không lớn hơn 3,5 m.
...
2.3.3.1.2. Hệ thống kết nối không dây thu, truyền dữ liệu đến thiết bị lắp trên xe sát hạch và sân sát hạch để báo lỗi, trừ điểm các lỗi vi phạm đảm bảo băng thông và tốc độ cho phép đánh giá chính xác
...
|Bảng 5: Điện áp danh|định và điện áp thử nghiệm thiết bị trên xe sát hạch| |---|---| |Điện áp danh định (V)|Điện áp thử nghiệm cắm ngược cực (V)| |06|06 ± 0,1| |12|14 ± 0,1| |24|28 ± 0,2|
...
RF, cổng COM (RS232), cổng USB (chuẩn 2.0 trở lên) hoặc thẻ nhớ để có thể điều chỉnh khi thay đổi quy định chấm điểm và phục vụ công tác kiểm tra, kiểm chuẩn thiết bị.
...
|Bảng 6: Điện áp danh|định và điện áp thử nghiệm thiết bị trên xe sát hạch| |---|---| |Điện áp danh định (V)|Điện áp thử nghiệm cắm ngược cực (V)| |12|14 ± 0,1| |24|28 ± 0,2| |36|42 ± 0,2|

2.3.4.2.5. Có khả năng tự động chụp ảnh ngẫu nhiên thí sinh ít nhất 03 lần trong quá trình thực hiện

các bài sát hạch, gửi dữ liệu ảnh chụp để lưu trữ vào cơ sở dữ liệu của máy tính tại phòng điều hành và in vào biên bản sát hạch thực hành lái xe trong hình.
...
2.3.5.2.3. Tự động phát hiện, báo lỗi, trừ điểm khi thí sinh vi phạm các lỗi về: thắt dây an toàn; bật và tắt xi nhan; xe sát hạch bị chết máy; kéo và nhả phanh tay; trong khoảng 15 mét, không điều khiển thay đổi số từ số 1 lên số 3; sử dụng tay số không phù hợp tốc độ xe; không tăng, giảm đúng số;
...
|Điện áp danh định (V)|Điện áp thử nghiệm cắm ngược cực (V)| |---|---| |12|14 ± 0,1| |24|28 ± 0,2| |36|42 ± 0,2|
...
điểm trừ lỗi vi phạm; tổng số điểm của thí sinh; tình trạng có sóng, mất sóng của hệ thống thông tin di động toàn cầu (GSM); tình trạng có kết nối, mất kết nối với máy chủ; tình trạng có tín hiệu, mất tín hiệu của hệ thống vệ tinh định vị toàn cầu (GNSS) ; tình trạng hoạt động của bộ nhớ lưu trữ dữ liệu.
...
3.2.1. Không được thay đổi vị trí, kết cấu lắp đặt thiết bị chấm điểm trên xe và sân sát hạch sau khi đã được kiểm tra, kiểm chuẩn; không được thay đổi hình dáng, kết cấu, tổng thành, hệ thống của xe sát
...
Kể từ ngày 01 tháng 7 năm 2025, các Trung tâm sát hạch lái xe cơ giới đường bộ này phải đảm bảo đáp ứng đủ các điều kiện quy định tại Quy chuẩn này mới được tiếp tục hoạt động sát hạch lái xe theo quy định.
...
MÔ TẢ GIAO THỨC TRUYỀN DỮ LIỆU GIỮA CÁC MÁY CHỦ SÁT HẠCH VÀ MÁY CHỦ GÍAM SÁT SÁT HẠCH

**1. Các yêu cầu chung**

|Thông số|Yêu cầu| |---|---| |Mô hình API|Theo chuẩn RESTful API, hỗ trợ kiểu dữ liệu JSON.| |Thông tin server|Do Cục Đường bộ Việt Nam công bố.| |Quy định|- Thông tin, dữ liệu cung cấp phải đảm bảo đầy đủ theo cấu trúc, định<br>dạng quy định tại phụ lục này<br>- Thông tin, dữ liệu cung cấp phải bảo đảm kịp thời, chính xác, đầy đủ,<br>không được sửa chữa hoặc làm sai lệch dữ liệu trước, trong hoặc sau khi<br>truyền dữ liệu.| |Giao thức truyền|Giao thức kết nối https sử dụng chứng chỉ TLS (được quy định tại Tiêu<br>chuẩn cơ sở TCCS 01:2020/CATTT)| |Định dạng dữ liệu gửi đi|Dữ liệu gửi lên server là định dạng JSON.<br>Thêm header: Content-Type: application/json| |Định dạng dữ liệu nhận về|Để nhận về dữ liệu dạng JSON<br>Thêm header: Accept: application/json| |Tiêu chuẩn dữ liệu|Hệ thống hỗ trợ dữ liệu chuẩn Unicode (UTF-8) (4)| |Tiêu chuẩn thời gian|Sử dụng chuẩn UNIX time (Giờ UTC+7): Thời gian Unix được định nghĩa<br>bằng số giây kể từ 00:00:00 theo giờ Phối hợp Quốc tế ngày 1 tháng 1<br>năm 1970, trừ đi giây nhuận. Tính đến giây.| |Bảo mật|- Giao thức truyền sử dụng HTTPS<br>- Đăng nhập và phân quyền sử dụng JWT (5)|

|Col1|- Chỉ cấp phép truyền dữ liệu cho một số IP định trước trong yêu cầu kết<br>nối của doanh nghiệp. Các IP không được đăng kí sẽ không kết nối được<br>đến phần mềm giám sát sát hạch Sở GTVT.| |---|---| |Độ trễ cho phép cho việc<br>truyền dữ liệu|2 phút| |Kích thước tối đa của một<br>ảnh|512 KB<br>Đây là kích thước tối đa của một ảnh mà Sở GTVT ghi nhận là một ảnh có<br>kích thước hợp lệ.| |Đồng bộ thời gian|Theo chuẩn NTP. TTSH cần đồng bộ thời gian với máy chủ nhà cung cấp.|

Dữ liệu trả về có định dạng chung như sau:

|Tên trường|Mô tả| |---|---| |**Code**|Mã lỗi (Giá trị 1 nếu request thành công)| |**Message**|Thông tin chi tiết về lỗi (“Thành công” hoặc không có nếu request thành công)| |**Data**|Dữ liệu trả về (Tùy thuộc vào từng API mà có các dữ liệu trả về khác nhau)| |**Extra**|Thông tin bổ sung (nếu có)| |**Exception**|Lỗi xảy ra (nếu có). TTSH thường xuyên kiểm tra trường Exception này để<br>xem thông tin nguyên nhân gây lỗi, mã lỗi.| |**ExceptionMessage**|Mô tả chi tiết về Exception (Nếu có). TTSH thường xuyên kiểm tra trường<br>ExceptionMessage để xem nguyên nhân, cách khắc phục.|
...
**Bước 3** : Khởi tạo quá trình truyền thông qua tập lệnh API được mô tả kèm theo tài liệu này. TTSH tiến hành tra soát các thông tin mà hệ thống trả về. Nếu mã trả về là OK thì hệ thống đã nhận được
...
|Thông số|Mô tả|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**URL**|api/v1/provider/login|api/v1/provider/login|api/v1/provider/login|api/v1/provider/login|api/v1/provider/login| |**Phương thức**|POST|POST|POST|POST|POST| |**Mô tả**|API này cho phép các TTSH lấy token của phiên đăng nhập. Token cung cấp quyền<br>giao tiếp với phần mềm giám sát sát hạch Sở GTVT|API này cho phép các TTSH lấy token của phiên đăng nhập. Token cung cấp quyền<br>giao tiếp với phần mềm giám sát sát hạch Sở GTVT|API này cho phép các TTSH lấy token của phiên đăng nhập. Token cung cấp quyền<br>giao tiếp với phần mềm giám sát sát hạch Sở GTVT|API này cho phép các TTSH lấy token của phiên đăng nhập. Token cung cấp quyền<br>giao tiếp với phần mềm giám sát sát hạch Sở GTVT|API này cho phép các TTSH lấy token của phiên đăng nhập. Token cung cấp quyền<br>giao tiếp với phần mềm giám sát sát hạch Sở GTVT| |**Dữ liệu đầu**<br>**vào**|**Tên trường**|**Kiểu dữ liệu**|**  Độ dài kí**<br>**tự**|**Bắt buộc**|**Mô tả**| |**Dữ liệu đầu**<br>**vào**|UserName|String|20|X|Tên người dùng| |**Dữ liệu đầu**<br>**vào**|Password|String|20|X|Mật khẩu của người dùng| |**Dữ liệu trả về**|**Tên trường**|**Kiểu dữ liệu**|**  Độ dài kí**<br>**tự**|**Bắt buộc**|**Mô tả**| |**Dữ liệu trả về**|Token|String|2000|X|Mã token sử dụng để xác thực<br>JWT|
...
|Thông số|Mô tả|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**URL**|api/v1/provider/logout|api/v1/provider/logout|api/v1/provider/logout|api/v1/provider/logout|api/v1/provider/logout| |**Phương thức**|POST|POST|POST|POST|POST| |**Mô tả**|API này cho phép đăng xuất một user khỏi hệ thống|API này cho phép đăng xuất một user khỏi hệ thống|API này cho phép đăng xuất một user khỏi hệ thống|API này cho phép đăng xuất một user khỏi hệ thống|API này cho phép đăng xuất một user khỏi hệ thống| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)|Authorization Token (Được khởi tạo sau quá trình login)|Authorization Token (Được khởi tạo sau quá trình login)|Authorization Token (Được khởi tạo sau quá trình login)|Authorization Token (Được khởi tạo sau quá trình login)| |**Dữ liệu đầu**<br>**vào**|**Tên trường**<br>|**Kiểu dữ liệu**|**  Độ dài kí**<br>**tự**|**Bắt buộc**|**Mô tả**| |**Dữ liệu đầu**<br>**vào**|UserName<br>|String|20|X|Tên đăng nhập người dùng| |**Dữ liệu trả về**|**  Tên trường**<br>|**Kiểu dữ liệu**|**  Độ dài kí**<br>**tự**|**Bắt buộc**|**Mô tả**| ||Code<br>|Int|5|X|Trạng thái thực hiện lệnh|
...
|Thông số|Mô tả|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**URL**|api/v1/provider/changepassword|api/v1/provider/changepassword|api/v1/provider/changepassword|api/v1/provider/changepassword|api/v1/provider/changepassword| |**Phương thức**|POST|POST|POST|POST|POST| |**Mô tả**|API này cho phép đổi mật khẩu của một user trên hệ thống|API này cho phép đổi mật khẩu của một user trên hệ thống|API này cho phép đổi mật khẩu của một user trên hệ thống|API này cho phép đổi mật khẩu của một user trên hệ thống|API này cho phép đổi mật khẩu của một user trên hệ thống| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)|Authorization Token (Được khởi tạo sau quá trình login)|Authorization Token (Được khởi tạo sau quá trình login)|Authorization Token (Được khởi tạo sau quá trình login)|Authorization Token (Được khởi tạo sau quá trình login)| |**Dữ liệu đầu**<br>**vào**|**Tên trường**|**Kiểu dữ liệu**|**  Độ dài kí**<br>**tự**|**Bắt buộc**|**Mô tả**| |**Dữ liệu đầu**<br>**vào**|UserName|String|20|X|Tên đăng nhập người dùng| |**Dữ liệu đầu**<br>**vào**|Password|String|20|X|Mật khẩu của người dùng| |**Dữ liệu đầu**<br>**vào**|NewPassword|String|20|X|Mật khẩu mới| |**Dữ liệu trả về**|**Tên trường**|**Kiểu dữ liệu**|**  Độ dài kí**<br>**tự**|**Bắt buộc**|**Mô tả**| ||Code|Int|5|X|Trạng thái thực hiện lệnh|

**c. Hàm kiểm tra thời gian máy chủ**

|Thông số|Mô tả|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**URL**|api/v1/server/getcurrentime|api/v1/server/getcurrentime|api/v1/server/getcurrentime|api/v1/server/getcurrentime|api/v1/server/getcurrentime| |**Phương thức**|POST|POST|POST|POST|POST| |**Mô tả**|API này cho phép lấy thông tin thời gian hiện tại của server|API này cho phép lấy thông tin thời gian hiện tại của server|API này cho phép lấy thông tin thời gian hiện tại của server|API này cho phép lấy thông tin thời gian hiện tại của server|API này cho phép lấy thông tin thời gian hiện tại của server| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)|Authorization Token (Được khởi tạo sau quá trình login)|Authorization Token (Được khởi tạo sau quá trình login)|Authorization Token (Được khởi tạo sau quá trình login)|Authorization Token (Được khởi tạo sau quá trình login)| |**Dữ liệu đầu**<br>**vào**|**Tên trường**<br>|**Kiểu dữ liệu**|**  Độ dài kí**<br>**tự**|**Bắt buộc**|**Mô tả**| |**Dữ liệu đầu**<br>**vào**|UserName<br>|String|20|X|Tên đăng nhập người dùng| |**Dữ liệu trả về**|**  Tên trường**<br>|**Kiểu dữ liệu**|**  Độ dài kí**<br>**tự**|**Bắt buộc**|**Mô tả**| ||CurrentTime<br>|Datetime||X|Thời gian hiện tại của Server|

**4.2. Các hàm truyền dữ liệu từ Sở GTVT**

a) Dữ liệu thông tin sát hạch

|Thông số|Mô tả| |---|---| |**URL**<br>|api/v1/data/exam| |**Phương thức**|POST| |**Mô tả**<br>|API cho phép truyền thông tin dữ liệu sát hạch từ phần mềm giám sát sát hạch tại Sở|

|Col1|GTVT tới Trung tâm sát hạch|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)<br>DepartmentTransport: Mã sở GTVT|Authorization Token (Được khởi tạo sau quá trình login)<br>DepartmentTransport: Mã sở GTVT|Authorization Token (Được khởi tạo sau quá trình login)<br>DepartmentTransport: Mã sở GTVT|Authorization Token (Được khởi tạo sau quá trình login)<br>DepartmentTransport: Mã sở GTVT|Authorization Token (Được khởi tạo sau quá trình login)<br>DepartmentTransport: Mã sở GTVT| |**Dữ liệu đầu**<br>**vào**|**Tên trường**|**Kiểu dữ**<br>**liệu**|**Độ dài kí**<br>**tự**|**Bắt buộc**|**Mô tả**| |**Dữ liệu đầu**<br>**vào**|TotalRecords|Int|5||Tổng số bản ghi| |**Dữ liệu đầu**<br>**vào**|ExamCode|String|20|X|Mã kỳ sát hạch| |**Dữ liệu đầu**<br>**vào**|ExamName|String|255|X|Tên kỳ sát hạch| |**Dữ liệu đầu**<br>**vào**|CenterID|String|10|X|Mã trung tâm sát hạch| |**Dữ liệu đầu**<br>**vào**|ExamDate|Date|10|X|Ngày sát hạch<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| |**Dữ liệu đầu**<br>**vào**|ExamTime|Int|4|X|Giờ sát hạch<br>Định dạng hhmm<br>VD: 730; 1400| |**Dữ liệu đầu**<br>**vào**|DecisionNo|String|30||Số quyết định| |**Dữ liệu đầu**<br>**vào**|DecisionDate|Date|10||Ngày quyết định<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| |**Dữ liệu đầu**<br>**vào**|DecisionMaker|String|255||Người ra quyết định| |**Dữ liệu đầu**<br>**vào**|BoardExaminers|List<Boar<br>dData>|||Danh sách hội đồng sát hạch<br>Tham chiếu mục 2. Dữ liệu<br>hội đồng sát hạch| |**Dữ liệu đầu**<br>**vào**|TotalRegister|Int|8||Tổng số học viên đăng ký| |**Dữ liệu đầu**<br>**vào**|StudentData|List<Stud<br>entData>||X|Danh sách học viên dự sát<br>hạch<br>Tham chiếu mục 3. Dữ liệu<br>học viên dự sát hạch| |**Dữ liệu trả về**|**Tên trường**|**Kiểu dữ**<br>**liệu**|**Độ dài kí**<br>**tự**|**Bắt buộc**|**Mô tả**| |**Dữ liệu trả về**|Code|Int|5|X|Mã thực thi lệnh|

b) Dữ liệu hội đồng sát hạch

|Tên trường|Kiểu dữ liệu|Độ dài kí tự|Bắt buộc|Mô tả| |---|---|---|---|---| |BoardExaminers|List<BoardData>|||Danh sách hội đồng sát<br>hạch| |Position|Int|2||Chức vụ:<br>1. Chủ tịch hội đồng sát<br>hạch<br>2. Ủy viên Giám đốc trung<br>tâm sát hạch<br>3. Ủy viên Giảm đốc cơ sở<br>đào tạo<br>4. Ủy viên tổ trưởng tổ sát<br>hạch<br>5. Ủy viên thư ký<br>6. Sát hạch viên| |ExaminersName|String|100||Họ và tên sát hạch viên|

c) Dữ liệu học viên dự sát hạch

|Tên trường|Kiểu dữ liệu|Độ dài kí tự|Bắt buộc|Mô tả| |---|---|---|---|---| |StudentData|List<StudentData>||X|Danh sách học viên dự sát<br>hạch| |StudentId|String|30|X|Mã đăng ký| |FullName|String|255|X|Họ và tên học viên| |Gender|Int|1|X|Giới tính<br>0 - Nam,<br>1 - Nữ,<br>2 - Khác| |DateOfBirth|Date|10|X|Ngày sinh<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| |CCCDID|String|50|X|CMND/ CCCD/ Hộ chiếu| |CountryCode|String|3|X|Danh mục nước<br>Thuộc danh mục| |Residence|String|255||Nơi cư trú| |ResidenceCode|String|30|X|Mã đơn vị hành chính<br>Thuộc danh mục| |ResidenceManage|String|30|X|Mã đơn vị quản lý<br>Thuộc danh mục| |FileNumber|String|30||Số hồ sơ| |RegistrationNo|String|30|X|Số báo danh| |TrainingCode|String|5||Mã cơ sở đào tạo| |DepartmentTransp ort|String|2|X|Sở GTVT<br>Thuộc danh mục| |CourseId|String|112||Mã khóa học| |HealthCertificate|Int|2||Giấy chứng nhận sức<br>khỏe:<br>1: Hợp lệ<br>0: Không| |LicenseAvailableNo|String|12||Số GPLX đã có| |LicenseAvailableType|String|5||Hạng GPLX đã có. Thuộc<br>danh mục:<br>+ A1: Hạng A1<br>+ A: Hạng A<br>+ B1: Hạng B1<br>+ B: Hạng B<br>+ C1: Hạng C1<br>+ C: Hạng C<br>+ D2: Hạng D2<br>+ D1: Hạng D1<br>+ D: Hạng D<br>+ BE: Hạng BE<br>+ C1E: Hạng C1E|

|Col1|Col2|Col3|Col4|+ CE: Hạng CE<br>+ D2E: Hạng D2E<br>+ D1E: Hạng D1E<br>+ DE: Hạng DE| |---|---|---|---|---| |LicenseAvailableUnit|String|255||Đơn vị quản lý GPLX đã có| |LicenseAvailableExpired|Date|10||Ngày hết hạn GPLX đã có<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| |YearExperience|Int|4||Số năm lái xe| |KmExperience|Int|8||Số km an toàn| |GraduationCertificate|String|30||Số giấy chứng nhận tốt<br>nghiệp| |VocationalCertificate|String|30||Số chứng chỉ nghề| |ExamContent|Int|5|X|Nội dung sát hạch. Thuộc<br>danh mục:<br>1: SH lần đầu (LT+H+D)<br>2: Lý thuyết<br>3: Lý thuyết + Trong hình<br>4: Lý thuyết + Trong hình +<br>Trên đường<br>5: Trong hình + Trên<br>đường<br>6: Đường<br>7: Trong hình<br>8: GPLX<br>11: SH lần đầu (L+M+H+Đ)<br>12: SH lại L+M+H+Đ<br>13: SH lại M+H+Đ<br>14: SH lại L+M| |ExamType|String|5|X|Hạng sát hạch. Thuộc danh<br>mục:<br>+ A1: Hạng A1<br>+ A: Hạng A<br>+ B1: Hạng B1<br>+ B: Hạng B<br>+ C1: Hạng C1<br>+ C: Hạng C<br>+ D2: Hạng D2<br>+ D1: Hạng D1<br>+ D: Hạng D<br>+ BE: Hạng BE<br>+ C1E: Hạng C1E<br>+ CE: Hạng CE<br>+ D2E: Hạng D2E<br>+ D1E: Hạng D1E<br>+ DE: Hạng DE|

|ReasonExamination|String|500|Col4|Lý do sát hạch| |---|---|---|---|---| |ImageData|String||X|Ảnh học viên Base64<br>Định dạng: JPEG, PNG| |ImageQuality|Int|2|X|Chất lượng ảnh:<br>- 1: true<br>- 0: false|
...
|Thông số|Mô tả|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**URL**|api/v1/data/result|api/v1/data/result|api/v1/data/result|api/v1/data/result|api/v1/data/result| |**Phương**<br>**thức**|POST|POST|POST|POST|POST| |**Mô tả**|API cho phép truyền thông tin kết quả sát hạch từng môn từ Trung tâm sát hạch tới<br>phần mềm giám sát sát hạch tại Sở GTVT|API cho phép truyền thông tin kết quả sát hạch từng môn từ Trung tâm sát hạch tới<br>phần mềm giám sát sát hạch tại Sở GTVT|API cho phép truyền thông tin kết quả sát hạch từng môn từ Trung tâm sát hạch tới<br>phần mềm giám sát sát hạch tại Sở GTVT|API cho phép truyền thông tin kết quả sát hạch từng môn từ Trung tâm sát hạch tới<br>phần mềm giám sát sát hạch tại Sở GTVT|API cho phép truyền thông tin kết quả sát hạch từng môn từ Trung tâm sát hạch tới<br>phần mềm giám sát sát hạch tại Sở GTVT| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch| |**Dữ liệu đầu**<br>**vào**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|<br>**Bắt buộc**|**Mô tả**| |**Dữ liệu đầu**<br>**vào**|StudentData|List<StudentData>||X<br>|Danh sách học viên| |**Dữ liệu đầu**<br>**vào**|StudentId|String|30|X<br>|Mã đăng ký| |**Dữ liệu đầu**<br>**vào**|FullName|String|255|X<br>|Họ và tên học viên| |**Dữ liệu đầu**<br>**vào**|DateOfBirth|Date|10|X<br> <br> <br>|Ngày sinh<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| |**Dữ liệu đầu**<br>**vào**|CCCDID|String|50|X<br>|CMND/ CCCD/ Hộ chiếu| |**Dữ liệu đầu**<br>**vào**|RegistrationNo|String|30|X<br>|Số báo danh| |**Dữ liệu đầu**<br>**vào**|ExamType|String|5|X<br> <br><br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br>|Hạng sát hạch. Thuộc danh<br>mục:<br>+ A1: Hạng A1<br>+ A: Hạng A<br>+ B1: Hạng B1<br>+ B: Hạng B<br>+ C1: Hạng C1<br>+ C: Hạng C<br>+ D2: Hạng D2<br>+ D1: Hạng D1<br>+ D: Hạng D<br>+ BE: Hạng BE<br>+ C1E: Hạng C1E<br>+ CE: Hạng CE<br>+ D2E: Hạng D2E<br>+ D1E: Hạng D1E<br>+ DE: Hạng DE| |**Dữ liệu đầu**<br>**vào**|ExamCode|String|20|X<br>|Mã kỳ sát hạch| |**Dữ liệu đầu**<br>**vào**|ExamType|Int|2|X<br>|Môn sát hạch:|

|Col1|Col2|Col3|Col4|Col5|1: Lý thuyết<br>2: Mô phỏng<br>3: Trong hình<br>4: Trên đường| |---|---|---|---|---|---| ||StartTime|Instant<br>|20|X|Thời gian bắt đầu sát hạch<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’| ||EndTime|Instant<br>|20||Thời gian kết thúc kết thúc<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’| ||Result|Int<br>|5|X|Điểm sát hạch| ||ProviderReceiveTim<br>e|Instant||X|Thời gian máy chủ NCC,<br>TTSH nhận được dữ liệu<br>sát hạch của thí sinh từ máy<br>chủ các môn sát hạch.<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’| ||TimesExam|Int<br>|3|X|Số lần sát hạch của thí sinh| ||Reason|String<br>|500||Lý do sát hạch lại<br>Bắt buộc khi số lần sát hạch<br>của thí sinh >1| ||ImageData|String|||Ảnh học viên<br>Base64<br>Định dạng: JPEG, PNG| |**Dữ liệu trả**<br>**về**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|<br>**Bắt buộc**|**Mô tả**| |**Dữ liệu trả**<br>**về**|Code|Int<br>|5|X|Mã thực thi lệnh|

b. Dữ liệu truyền thông tin tổng hợp kết quả sát hạch từ Trung tâm sát hạch tới phần mềm giám sát sát hạch tại Sở GTVT:

|Thông số|Mô tả|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**URL**|api/v1/data/summary|api/v1/data/summary|api/v1/data/summary|api/v1/data/summary|api/v1/data/summary| |**Phương thức**|POST|POST|POST|POST|POST| |**Mô tả**|API cho phép truyền thông tin kết quả sát hạch từng môn từ Trung tâm sát hạch tới<br>phần mềm giám sát sát hạch tại Sở GTVT|API cho phép truyền thông tin kết quả sát hạch từng môn từ Trung tâm sát hạch tới<br>phần mềm giám sát sát hạch tại Sở GTVT|API cho phép truyền thông tin kết quả sát hạch từng môn từ Trung tâm sát hạch tới<br>phần mềm giám sát sát hạch tại Sở GTVT|API cho phép truyền thông tin kết quả sát hạch từng môn từ Trung tâm sát hạch tới<br>phần mềm giám sát sát hạch tại Sở GTVT|API cho phép truyền thông tin kết quả sát hạch từng môn từ Trung tâm sát hạch tới<br>phần mềm giám sát sát hạch tại Sở GTVT| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch| |**Dữ liệu đầu**<br>**vào**|**Tên trường**<br>|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|**Bắt buộc**|**Mô tả**| |**Dữ liệu đầu**<br>**vào**|StudentData<br>|List<StudentData>||X|Danh sách học viên| |**Dữ liệu đầu**<br>**vào**|StudentId<br>|String|30|X|Mã đăng ký| |**Dữ liệu đầu**<br>**vào**|FullName<br>|String|255|X|Họ và tên học viên| |**Dữ liệu đầu**<br>**vào**|DateOfBirth<br>|Date|10|X|Ngày sinh<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| |**Dữ liệu đầu**<br>**vào**|CCCDID<br>|String|50|X|CMND/ CCCD/ Hộ chiếu| |**Dữ liệu đầu**<br>**vào**|RegistrationNo<br>|String|30|X|Số báo danh| |**Dữ liệu đầu**<br>**vào**|ExamType<br>|String|5|X|Hạng sát hạch. Thuộc<br>danh mục:|

|Col1|Col2|Col3|Col4|Col5|+ A1: Hạng A1<br>+ A: Hạng A<br>+ B1: Hạng B1<br>+ B: Hạng B<br>+ C1: Hạng C1<br>+ C: Hạng C<br>+ D2: Hạng D2<br>+ D1: Hạng D1<br>+ D: Hạng D<br>+ BE: Hạng BE<br>+ C1E: Hạng C1E<br>+ CE: Hạng CE<br>+ D2E: Hạng D2E<br>+ D1E: Hạng D1E<br>+ DE: Hạng DE| |---|---|---|---|---|---| ||ExamCode|String|20|X|Mã kỳ sát hạch| ||TheoryResults|String|2||Bắt buộc nhập ít nhất dữ<br>liệu của 1 môn, bao gồm<br>trường kết quả thi và<br>điểm Kết quả thi lý<br>thuyết<br>DA: Đạt<br>RO: Không đạt| ||TheoryPoint|Int|5||Điểm lý thuyết| ||SimulationResults|String|2||Kết quả thi mô phỏng<br>DA: Đạt<br>RO: Không đạt| ||SimulationPoint|Int|5||Điểm mô phỏng| ||TestRoutesResults|String|2||Kết quả thi trong hình<br>DA: Đạt<br>RO: Không đạt| ||TestRoutesPoint|Int|5||Điểm trong hình| ||RoadResults|String|2||Kết quả thi trên đường<br>DA: Đạt<br>RO: Không đạt| ||RoadPoint|Int|5||Điểm trên đường| ||Summary|String|5|X|Tổng hợp kết quả sát<br>hạch<br>DA: Đạt<br>RO: Không đạt| |**Dữ liệu trả về**|||||| |**Dữ liệu trả về**|Code|Int|5|X|Mã thực thi lệnh|
...
|Thông số|Mô tả| |---|---| |**URL**|api/v1/data/rollcall|

|Phương<br>thức|POST|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**Mô tả**|API cho phép truyền thông tin điểm danh từ hệ thống giám sát sát hạch Trung tâm sát<br>hạch tới phần mềm giám sát hạch tại Sở GTVT|API cho phép truyền thông tin điểm danh từ hệ thống giám sát sát hạch Trung tâm sát<br>hạch tới phần mềm giám sát hạch tại Sở GTVT|API cho phép truyền thông tin điểm danh từ hệ thống giám sát sát hạch Trung tâm sát<br>hạch tới phần mềm giám sát hạch tại Sở GTVT|API cho phép truyền thông tin điểm danh từ hệ thống giám sát sát hạch Trung tâm sát<br>hạch tới phần mềm giám sát hạch tại Sở GTVT|API cho phép truyền thông tin điểm danh từ hệ thống giám sát sát hạch Trung tâm sát<br>hạch tới phần mềm giám sát hạch tại Sở GTVT| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch| |**Dữ liệu đầu**<br>**vào**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|**Bắt buộc**|**  Mô tả**| |**Dữ liệu đầu**<br>**vào**|StudentData|List<StudentData>||X|Danh sách học viên| |**Dữ liệu đầu**<br>**vào**|StudentId|String|30|X|Mã đăng ký| |**Dữ liệu đầu**<br>**vào**|FullName|String|255|X|Họ và tên học viên| |**Dữ liệu đầu**<br>**vào**|DateOfBirth|Date|10|X|Ngày sinh<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| |**Dữ liệu đầu**<br>**vào**|CCCDID|String|50|X|CMND/ CCCD/ Hộ chiếu| |**Dữ liệu đầu**<br>**vào**|RegistrationNo|String|30|X|Số báo danh| |**Dữ liệu đầu**<br>**vào**|ExamType|String|5|X|Hạng sát hạch. Thuộc danh<br>mục:<br>+ A1: Hạng A1<br>+ A: Hạng A<br>+ B1: Hạng B1<br>+ B: Hạng B<br>+ C1: Hạng C1<br>+ C: Hạng C<br>+ D2: Hạng D2<br>+ D1: Hạng D1<br>+ D: Hạng D<br>+ BE: Hạng BE<br>+ C1E: Hạng C1E<br>+ CE: Hạng CE<br>+ D2E: Hạng D2E<br>+ D1E: Hạng D1E<br>+ DE: Hạng DE| |**Dữ liệu đầu**<br>**vào**|ExamCode|String|20|X|Mã kỳ sát hạch| |**Dữ liệu đầu**<br>**vào**|TheoryRollCall|Int|5||Bắt buộc nhập ít nhất 1 giá<br>trị điểm danh<br>Điểm danh thi lý thuyết<br>0: Vắng mặt<br>1: Có| |**Dữ liệu đầu**<br>**vào**|SimulationRollCall|Int|5||Điểm danh thi mô phỏng<br>0: Vắng mặt<br>1: Có| |**Dữ liệu đầu**<br>**vào**|TestRoutesRollCall|Int|5||Điểm danh thi trong hình<br>0: Vắng mặt<br>1: Có| |**Dữ liệu đầu**<br>**vào**|RoadRollCall|Int|5||Điểm danh thi trên đường|

|Col1|Col2|Col3|Col4|Col5|0: Vắng mặt<br>1: Có| |---|---|---|---|---|---| |**Dữ liệu trả**<br>**về**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|**Bắt buộc**|** Mô tả**| |**Dữ liệu trả**<br>**về**|Code|Int|5|X|Mã thực thi lệnh|

d. Dữ liệu truyền thông tin hủy kết quả sát hạch

|Thông số|Mô tả|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**URL**|api/v1/data/cancel|api/v1/data/cancel|api/v1/data/cancel|api/v1/data/cancel|api/v1/data/cancel| |**Phương**<br>**thức**|POST|POST|POST|POST|POST| |**Mô tả**|API cho phép truyền thông tin hủy kết quả sát hạch|API cho phép truyền thông tin hủy kết quả sát hạch|API cho phép truyền thông tin hủy kết quả sát hạch|API cho phép truyền thông tin hủy kết quả sát hạch|API cho phép truyền thông tin hủy kết quả sát hạch| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch| |**Dữ liệu đầu**<br>**vào**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|**Bắt buộc**|**  Mô tả**| |**Dữ liệu đầu**<br>**vào**|StudentData|List<StudentData>||X|Danh sách học viên| |**Dữ liệu đầu**<br>**vào**|StudentId|String|30|X|Mã đăng ký| |**Dữ liệu đầu**<br>**vào**|FullName|String|255|X|Họ và tên học viên| |**Dữ liệu đầu**<br>**vào**|DateOfBirth|Date|10|X|Ngày sinh<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| |**Dữ liệu đầu**<br>**vào**|CCCDID|String|50|X|CMND/ CCCD/ Hộ chiếu| |**Dữ liệu đầu**<br>**vào**|RegistrationNo|String|30|X|Số báo danh| |**Dữ liệu đầu**<br>**vào**|ExamType|String|5|X|Hạng sát hạch. Thuộc<br>danh mục:<br>+ A1: Hạng A1<br>+ A: Hạng A<br>+ B1: Hạng B1<br>+ B: Hạng B<br>+ C1: Hạng C1<br>+ C: Hạng C<br>+ D2: Hạng D2<br>+ D1: Hạng D1<br>+ D: Hạng D<br>+ BE: Hạng BE<br>+ C1E: Hạng C1E<br>+ CE: Hạng CE<br>+ D2E: Hạng D2E<br>+ D1E: Hạng D1E<br>+ DE: Hạng DE| |**Dữ liệu đầu**<br>**vào**|ExamCode|String|20|X|Mã kỳ sát hạch| |**Dữ liệu đầu**<br>**vào**|ExamType|Int|2|X|Môn sát hạch:<br>1: Lý thuyết<br>2: Mô phỏng<br>3: Trong hình|

|Col1|Col2|Col3|Col4|Col5|4: Trên đường| |---|---|---|---|---|---| ||TimesExam|Int|3|X|Số lần sát hạch của thí<br>sinh| ||Reason|String|500|X|Lý do hủy kết quả sát hạch| |**Dữ liệu trả**<br>**về**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|**Bắt buộc**|** Mô tả**| |**Dữ liệu trả**<br>**về**|Code|Int|5|X|Mã thực thi lệnh|
...
|Thông số|Mô tả|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**URL**|api/v1/data/theoryexam|api/v1/data/theoryexam|api/v1/data/theoryexam|api/v1/data/theoryexam|api/v1/data/theoryexam| |**Phương thức**|POST|POST|POST|POST|POST| |**Mô tả**|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch lý thuyết|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch lý thuyết|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch lý thuyết|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch lý thuyết|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch lý thuyết| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch| |**Dữ liệu đầu**<br>**vào**|**Tên trường**|**Kiểu dữ liệu**|**  Độ dài kí**<br>**tự**|**Bắt buộc**|** Mô tả**| |**Dữ liệu đầu**<br>**vào**|ProviderId|String|20|X|Đơn vị cung cấp| |**Dữ liệu đầu**<br>**vào**|TotalRecords|Int|5||Tổng số bản ghi| |**Dữ liệu đầu**<br>**vào**|ExamCode|String|20|X|Mã kỳ sát hạch| |**Dữ liệu đầu**<br>**vào**|ExamDate|Date|10|X|Ngày sát hạch<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| |**Dữ liệu đầu**<br>**vào**|ExamTime|Int|4|X|Giờ sát hạch<br>Định dạng hhmm<br>VD: 0730; 1400| |**Dữ liệu đầu**<br>**vào**|DecisionNo|String|30||Số quyết định| |**Dữ liệu đầu**<br>**vào**|DecisionDate|Date|10||Ngày quyết định<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| |**Dữ liệu đầu**<br>**vào**|DecisionMaker|String|255||Người ra quyết định| |**Dữ liệu đầu**<br>**vào**|BoardExaminers|List<Board<br>Data>|||Danh sách hội đồng sát<br>hạch<br>Tham chiếu mục 2. Dữ liệu<br>hội đồng sát hạch| |**Dữ liệu đầu**<br>**vào**|StudentData|List<Stude<br>ntData>||X|Danh sách học viên dự sát<br>hạch<br>Tham chiếu mục 3. Dữ liệu<br>học viên dự sát hạch lý<br>thuyết| |**Dữ liệu trả về**|**  Tên trường**|**Kiểu dữ liệu**|**  Độ dài kí**<br>**tự**|**Bắt buộc**|** Mô tả**| ||Code|Int|5|X|Mã thực thi lệnh|
...
|Tên trường|Kiểu dữ liệu|Độ dài kí tự|Bắt buộc|Mô tả| |---|---|---|---|---| |StudentData|List<StudentData>||X|Danh sách học viên dự sát<br>hạch| |StudentId|String|30|X|Mã đăng ký| |FullName|String|255|X|Họ và tên học viên| |Gender|Int|1|X|Giới tính<br>0 - Nam,<br>1 - Nữ,<br>2 - Khác| |DateOfBirth|Date|10|X|Ngày sinh<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| |CCCDID|String|50|X|CMND/ CCCD/ Hộ chiếu| |CountryCode|String|3|X|Danh mục nước<br>Thuộc danh mục| |Residence|String|255||Nơi cư trú| |ResidenceCode|String|30|X|Mã đơn vị hành chính<br>Thuộc danh mục| |ResidenceManage|String|30|X|Mã đơn vị quản lý<br>Thuộc danh mục| |FileNumber|String|30||Số hồ sơ| |RegistrationNo|String|30|X|Số báo danh| |TrainingCode|String|5||Mã cơ sở đào tạo| |ExamContent|Int|5|X|Nội dung sát hạch. Thuộc<br>danh mục:<br>1: SH lần đầu (LT+H+D)<br>2: Lý thuyết<br>3: Lý thuyết + Trong hình<br>4: Lý thuyết + Trong hình +<br>Trên đường<br>5: Trong hình + Trên đường|

|Col1|Col2|Col3|Col4|6: Đường<br>7: Trong hình<br>8: GPLX<br>11: SH lần đầu (L+M+H+Đ)<br>12: SH lại L+M+H+Đ<br>13: SH lại M+H+Đ<br>14: SH lại L+M| |---|---|---|---|---| |ExamType|String|5|X|Hạng sát hạch. Thuộc danh<br>mục:<br>+A1: Hạng A1<br>+ A: Hạng A<br>+ B1: Hạng B1<br>+ B: Hạng B<br>+ C1: Hạng C1<br>+ C: Hạng C<br>+ D2: Hạng D2<br>+ D1: Hạng D1<br>+ D: Hạng D<br>+ BE: Hạng BE<br>+ C1E: Hạng C1E<br>+ CE: Hạng CE<br>+ D2E: Hạng D2E<br>+ D1E: Hạng D1E<br>+ DE: Hạng DE| |ReasonExamination|String|255||Lý do sát hạch| |ImageData|String||X|Ảnh học viên<br>Base64<br>Định dạng: JPEG, PNG| |ImageQuality|Int|2|X|Chất lượng ảnh:<br>- 1: true<br>- 0: false| |ContentNote|String|500||Ghi chú|
...
|Thông số|Mô tả|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**URL**|api/v1/data/theoryresult|api/v1/data/theoryresult|api/v1/data/theoryresult|api/v1/data/theoryresult|api/v1/data/theoryresult| |**Phương**<br>**thức**|POST|POST|POST|POST|POST| |**Mô tả**|API cho phép cập nhật thông tin kết quả sát hạch lý thuyết từ phần mềm sát hạch lý<br>thuyết đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch lý thuyết từ phần mềm sát hạch lý<br>thuyết đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch lý thuyết từ phần mềm sát hạch lý<br>thuyết đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch lý thuyết từ phần mềm sát hạch lý<br>thuyết đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch lý thuyết từ phần mềm sát hạch lý<br>thuyết đến phần mềm giám sát sát hạch trung tâm sát hạch| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp| |**Dữ liệu đầu**<br>**vào**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|<br>**Bắt buộc**|**Mô tả**| |**Dữ liệu đầu**<br>**vào**|CenterID|String|20|X|Mã trung tâm sát hạch| |**Dữ liệu đầu**<br>**vào**|StudentData|List<StudentData>||X|Danh sách học viên dự sát|

|Col1|Col2|Col3|Col4|Col5|hạch| |---|---|---|---|---|---| ||StudentId|String|30|X|Mã đăng ký| ||FullName|String|255|X|Họ và tên học viên| ||DateOfBirth|Date|10|X|Ngày sinh<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| ||CCCDID|String|50|X|CMND/ CCCD/ Hộ chiếu| ||RegistrationNo|String|30|X|Số báo danh| ||ExamType|String|5|X|Hạng sát hạch. Thuộc<br>danh mục:<br>+ A1: Hạng A1<br>+ A: Hạng A<br>+ B1: Hạng B1<br>+ B: Hạng B<br>+ C1: Hạng C1<br>+ C: Hạng C<br>+ D2: Hạng D2<br>+ D1: Hạng D1<br>+ D: Hạng D<br>+ BE: Hạng BE<br>+ C1E: Hạng C1E<br>+ CE: Hạng CE<br>+ D2E: Hạng D2E<br>+ D1E: Hạng D1E<br>+ DE: Hạng DE| ||ExamCode|String|20|X|Mã kỳ sát hạch| ||ExamType|Int|2|X|Môn sát hạch:<br>1: Lý thuyết| ||StartTime|Instant|20|X|Thời gian bắt đầu sát hạch<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’| ||EndTime|Instant|20||Thời gian kết thúc kết thúc<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’| ||Result|Int|5|X|Điểm sát hạch| ||ImageData|String|||Ảnh học viên Base64<br>Định dạng: JPEG, PNG| |**Dữ liệu trả**<br>**về**<br> <br>|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|<br>**Bắt buộc**|** Mô tả**| |**Dữ liệu trả**<br>**về**<br> <br>|Code|Int|5|X|Mã thực thi lệnh|
...
|URL|api/v1/data/simulationexam|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**Phương**<br>**thức**|POST|POST|POST|POST|POST| |**Mô tả**|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch mô phỏng|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch mô phỏng|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch mô phỏng|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch mô phỏng|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch mô phỏng| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch| |**Dữ liệu đầu**<br>**vào**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|**Bắt buộc**|**  Mô tả**| ||ProviderId|String|20|X|Đơn vị cung cấp| ||TransactionCode|String|255|X|Mã giao dịch| ||DateSent|Date|20|X|Ngày gửi<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’<br>VD: 2024-01-01T00:00:00Z| ||Sender|String|255|X|Người gửi| ||TotalRecords|Int|5||Tổng số bản ghi| ||ExamCode|String|20|X|Mã kỳ sát hạch| ||ExamDate|Date|10|X|Ngày sát hạch<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| ||ExamTime|Int|4|X|Giờ sát hạch<br>Định dạng hhmm<br>VD: 730; 1400| ||DecisionNo|String|30||Số quyết định| ||DecisionDate|Date|10||Ngày quyết định<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| ||DecisionMaker|String|255||Người ra quyết định| ||BoardExaminers|List<BoardData>|||Danh sách hội đồng sát<br>hạch<br>Tham chiếu mục 2. Dữ liệu<br>hội đồng sát hạch| ||StudentData|List<StudentData>||X|Danh sách học viên dự sát<br>hạch<br>Tham chiếu mục 3. Dữ liệu<br>học viên dự sát hạch mô<br>phỏng| |**Dữ liệu trả**<br>**về**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|<br>**Bắt buộc**|**Mô tả**| |**Dữ liệu trả**<br>**về**|Code|Int|5|X|Mã thực thi lệnh|

b) Dữ liệu hội đồng sát hạch

|Tên trường|Kiểu dữ liệu|Độ dài kí tự|Bắt buộc|Mô tả| |---|---|---|---|---| |BoardExaminers|List<BoardData>|||Danh sách hội đồng sát<br>hạch| |Position|Int|2||Chức vụ:<br>1. Chủ tịch hội đồng sát<br>hạch|

|Col1|Col2|Col3|Col4|2. Ủy viên Giám đốc trung<br>tâm sát hạch<br>3. Uỷ viên Giảm đốc cơ sở<br>đào tạo<br>4. Ủy viên tổ trưởng tổ sát<br>hạch<br>5. Ủy viên thư ký<br>6. Sát hạch viên| |---|---|---|---|---| |ExaminersName|String|100||Họ và tên sát hạch viên|

c) Dữ liệu học viên dự sát hạch

|Tên trường|Kiểu dữ liệu|Độ dài kí tự|Bắt buộc|Mô tả| |---|---|---|---|---| |StudentData|List<StudentData>||X|Danh sách học viên dự sát<br>hạch| |StudentId|String|30|X|Mã đăng ký| |FullName|String|255|X|Họ và tên học viên| |Gender|Int|1|X|Giới tính<br>0 - Nam,<br>1 - Nữ,<br>2 - Khác| |DateOfBirth|Date|10|X|Ngày sinh<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| |CCCDID|String|50|X|CMND/ CCCD/ Hộ chiếu| |CountryCode|String|3|X|Danh mục nước<br>Thuộc danh mục| |Residence|String|255||Nơi cư trú| |ResidenceCode|String|30|X|Mã đơn vị hành chính<br>Thuộc danh mục| |ResidenceManage|String|30|X|Mã đơn vị quản lý<br>Thuộc danh mục| |FileNumber|String|30||Số hồ sơ| |RegistrationNo|String|30|X|Số báo danh| |TrainingCode|String|5||Mã cơ sở đào tạo| |ExamContent|Int|5|X|Nội dung sát hạch. Thuộc<br>danh mục:<br>1: SH lần đầu (LT+H+D)<br>2: Lý thuyết<br>3: Lý thuyết + Trong hình<br>4: Lý thuyết + Trong hình +<br>Trên đường<br>5: Trong hình + Trên đường<br>6: Đường<br>7: Trong hình<br>8: GPLX<br>11: SH lần đầu (L+M+H+Đ)<br>12: SH lại L+M+H+Đ|

|Col1|Col2|Col3|Col4|13: SH lại M+H+Đ<br>14: SH lại L+M| |---|---|---|---|---| |ExamType|String|5|X|Hạng sát hạch. Thuộc danh<br>mục:<br>+A1: Hạng A1<br>+ A: Hạng A<br>+ B1: Hạng B1<br>+ B: Hạng B<br>+ C1: Hạng C1<br>+ C: Hạng C<br>+ D2: Hạng D2<br>+ D1: Hạng D1<br>+ D: Hạng D<br>+ BE: Hạng BE<br>+ C1E: Hạng C1E<br>+ CE: Hạng CE<br>+ D2E: Hạng D2E<br>+ D1E: Hạng D1E<br>+ DE: Hạng DE| |ReasonExamination|String|255||Lý do sát hạch| |ImageData|String||X|Ảnh học viên<br>Base64<br>Định dạng: JPEG, PNG| |ImageQuality|Int|2|X|Chất lượng ảnh:<br>- 1: true<br>- 0: false| |**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí tự**|**Bắt buộc**|**Mô tả**| |ContentNote|String|500||Ghi chú|
...
|Thông số|Mô tả|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**URL**|api/v1/data/simulationresult|api/v1/data/simulationresult|api/v1/data/simulationresult|api/v1/data/simulationresult|api/v1/data/simulationresult| |**Phương**<br>**thức**|POST|POST|POST|POST|POST| |**Mô tả**|API cho phép cập nhật thông tin kết quả sát hạch mô phỏng từ phần mềm sát hạch mô<br>phỏng đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch mô phỏng từ phần mềm sát hạch mô<br>phỏng đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch mô phỏng từ phần mềm sát hạch mô<br>phỏng đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch mô phỏng từ phần mềm sát hạch mô<br>phỏng đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch mô phỏng từ phần mềm sát hạch mô<br>phỏng đến phần mềm giám sát sát hạch trung tâm sát hạch| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp| |**Dữ liệu đầu**<br>**vào**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|<br>**Bắt buộc**|**Mô tả**| |**Dữ liệu đầu**<br>**vào**|CenterID|String|20|X|Mã trung tâm sát hạch| |**Dữ liệu đầu**<br>**vào**|DateSent|Date|20|X|Ngày gửi<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’<br>VD: 2024-01-<br>01T00:00:00Z| |**Dữ liệu đầu**<br>**vào**|StudentData|List<StudentData>||X|Danh sách học viên dự sát|

|Col1|Col2|Col3|Col4|Col5|hạch| |---|---|---|---|---|---| ||StudentId|String|30|X|Mã đăng ký| ||FullName|String|255|X|Họ và tên học viên| ||DateOfBirth|Date|10|X|Ngày sinh<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| ||CCCDID|String|50|X|CMND/ CCCD/ Hộ chiếu| ||RegistrationNo|String|30|X|Số báo danh| ||ExamType|String|5|X|Hạng sát hạch. Thuộc<br>danh mục:<br>+ A1: Hạng A1<br>+ A: Hạng A<br>+ B1: Hạng B1<br>+ B: Hạng B<br>+ C1: Hạng C1<br>+ C: Hạng C<br>+ D2: Hạng D2<br>+ D1: Hạng D1<br>+ D: Hạng D<br>+ BE: Hạng BE<br>+ C1E: Hạng C1E<br>+ CE: Hạng CE<br>+ D2E: Hạng D2E<br>+ D1E: Hạng D1E<br>+ DE: Hạng DE| ||ExamCode|String|20|X|Mã kỳ sát hạch| ||ExamType|Int|2|X|Môn sát hạch:<br>2: Mô phỏng| ||StartTime|Instant|20|X|Thời gian bắt đầu sát hạch<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’| ||EndTime|Instant|20||Thời gian kết thúc kết thúc<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’| ||Result|Int|5|X|Điểm sát hạch| ||ImageData|String|||Ảnh học viên<br>Base64<br>Định dạng: JPEG, PNG| |**Dữ liệu trả**<br>**về**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|<br>**Bắt buộc**|** Mô tả**| |**Dữ liệu trả**<br>**về**|Code|Int|5|X|Mã thực thi lệnh|
...
|Thông số|Mô tả|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**URL**|api/v1/data/testroutesexam|api/v1/data/testroutesexam|api/v1/data/testroutesexam|api/v1/data/testroutesexam|api/v1/data/testroutesexam| |**Phương**<br>**thức**|POST|POST|POST|POST|POST| |**Mô tả**|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch trong hình|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch trong hình|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch trong hình|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch trong hình|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch trong hình| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch| |**Dữ liệu đầu**<br>**vào**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|<br>**Bắt buộc**|**Mô tả**| ||ProviderId|String|20|X|Đơn vị cung cấp| ||TransactionCode|String|255|X|Mã giao dịch| ||DateSent|Date|20|X|Ngày gửi<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’<br>VD: 2024-01-01T00:00:00Z| ||Sender|String|255|X|Người gửi| ||TotalRecords|Int|5||Tổng số bản ghi| ||ExamCode|String|20|X|Mã kỳ sát hạch| ||ExamDate|Date|10|X|Ngày sát hạch<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| ||ExamTime|Int|4|X|Giờ sát hạch<br>Định dạng hhmm<br>VD: 730; 1400| ||DecisionNo|String|30||Số quyết định| ||DecisionDate|Date|10||Ngày quyết định<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| ||DecisionMaker|String|255||Người ra quyết định| ||BoardExaminers|List<BoardData>|||Danh sách hội đồng sát<br>hạch<br>Tham chiếu mục 2. Dữ liệu<br>hội đồng sát hạch| ||StudentData|List<StudentData>||X|Danh sách học viên dự sát<br>hạch<br>Tham chiếu mục 3. Dữ liệu<br>học viên dự sát hạch trong<br>hình| |**Dữ liệu trả**<br>**về**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|<br>**Bắt buộc**|**Mô tả**| |**Dữ liệu trả**<br>**về**|Code|Int|5|X|Mã thực thi lệnh|

b) Dữ liệu hội đồng sát hạch

|Tên trường|Kiểu dữ liệu|Độ dài kí tự|Bắt buộc|Mô tả| |---|---|---|---|---| |BoardExaminers|List<BoardData>|||Danh sách hội đồng sát<br>hạch| |Position|Int|2||Chức vụ:<br>1. Chủ tịch hội đồng sát|

|Col1|Col2|Col3|Col4|hạch<br>2. Ủy viên Giám đốc trung<br>tâm sát hạch<br>3. Ủy viên Giảm đốc cơ sở<br>đào tạo<br>4. Ủy viên tổ trưởng tổ sát<br>hạch<br>5. Ủy viên thư ký<br>6. Sát hạch viên| |---|---|---|---|---| |ExaminersName|String|100||Họ và tên sát hạch viên|

c) Dữ liệu học viên dự sát hạch trong hình

|Tên trường|Kiểu dữ liệu|Độ dài kí tự|Bắt buộc|Mô tả| |---|---|---|---|---| |StudentData|List<StudentData>||X|Danh sách học viên dự sát<br>hạch| |StudentId|String|30|X|Mã đăng ký| |FullName|String|255|X|Họ và tên học viên| |Gender|Int|1|X|Giới tính<br>0 - Nam,<br>1 - Nữ,<br>2 - Khác| |DateOfBirth|Date|10|X|Ngày sinh<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| |CCCDID|String|50|X|CMND/ CCCD/ Hộ chiếu| |CountryCode|String|3|X|Danh mục nước<br>Thuộc danh mục| |Residence|String|255||Nơi cư trú| |ResidenceCode|String|30|X|Mã đơn vị hành chính<br>Thuộc danh mục| |ResidenceManage|String|30|X|Mã đơn vị quản lý<br>Thuộc danh mục| |FileNumber|String|30||Số hồ sơ| |RegistrationNo|String|30|X|Số báo danh| |TrainingCode|String|5||Mã cơ sở đào tạo| |ExamContent|Int|5|X|Nội dung sát hạch. Thuộc<br>danh mục:<br>1: SH lần đầu (LT+H+D)<br>2: Lý thuyết<br>3: Lý thuyết + Trong hình<br>4: Lý thuyết + Trong hình +<br>Trên đường<br>5: Trong hình + Trên đường<br>6: Đường<br>7: Trong hình<br>8: GPLX<br>11: SH lần đầu (L+M+H+Đ)|

|Col1|Col2|Col3|Col4|12: SH lại L+M+H+Đ<br>13: SH lại M+H+Đ<br>14: SH lại L+M| |---|---|---|---|---| |ExamType|String|5|X|Hạng sát hạch. Thuộc danh<br>mục:<br>+A1: Hạng A1<br>+ A: Hạng A<br>+ B1: Hạng B1<br>+ B: Hạng B<br>+ C1: Hạng C1<br>+ C: Hạng C<br>+ D2: Hạng D2<br>+ D1: Hạng D1<br>+ D: Hạng D<br>+ BE: Hạng BE<br>+ C1E: Hạng C1E<br>+ CE: Hạng CE<br>+ D2E: Hạng D2E<br>+ D1E: Hạng D1E<br>+ DE: Hạng DE| |ReasonExamination|String|255||Lý do sát hạch| |ImageData|String||X|Ảnh học viên<br>Base64<br>Định dạng: JPEG, PNG| |ImageQuality|Int|2|X|Chất lượng ảnh:<br>- 1: true<br>- 0: false| |ContentNote|String|500||Ghi chú|
...
|Thông số|Mô tả|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**URL**|api/v1/data/testroutesresult|api/v1/data/testroutesresult|api/v1/data/testroutesresult|api/v1/data/testroutesresult|api/v1/data/testroutesresult| |**Phương**<br>**thức**|POST|POST|POST|POST|POST| |**Mô tả**|API cho phép cập nhật thông tin kết quả sát hạch trong hình từ phần mềm sát hạch<br>trong hình đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch trong hình từ phần mềm sát hạch<br>trong hình đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch trong hình từ phần mềm sát hạch<br>trong hình đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch trong hình từ phần mềm sát hạch<br>trong hình đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch trong hình từ phần mềm sát hạch<br>trong hình đến phần mềm giám sát sát hạch trung tâm sát hạch| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp| |**Dữ liệu đầu**<br>**vào**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|<br>**Bắt buộc**|**Mô tả**| |**Dữ liệu đầu**<br>**vào**|CenterID|String|20|X|Mã trung tâm sát hạch| |**Dữ liệu đầu**<br>**vào**|DateSent|Date|20|X|Ngày gửi<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’<br>VD: 2024-01-<br>01T00:00:00Z| |**Dữ liệu đầu**<br>**vào**|StudentData|List<StudentData>||X|Danh sách học viên dự sát|

|Col1|Col2|Col3|Col4|Col5|hạch| |---|---|---|---|---|---| ||StudentId|String|30|X|Mã đăng ký| ||FullName|String|255|X|Họ và tên học viên| ||DateOfBirth|Date|10|X|Ngày sinh<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| ||CCCDID|String|50|X|CMND/ CCCD/ Hộ chiếu| ||RegistrationNo|String|30|X|Số báo danh| ||ExamType|String|5|X|Hạng sát hạch. Thuộc<br>danh mục:<br>+ A1: Hạng A1<br>+ A: Hạng A<br>+ B1: Hạng B1<br>+ B: Hạng B<br>+ C1: Hạng C1<br>+ C: Hạng C<br>+ D2: Hạng D2<br>+ D1: Hạng D1<br>+ D: Hạng D<br>+ BE: Hạng BE<br>+ C1E: Hạng C1E<br>+ CE: Hạng CE<br>+ D2E: Hạng D2E<br>+ D1E: Hạng D1E<br>+ DE: Hạng DE| ||ExamCode|String|20|X|Mã kỳ sát hạch| ||ExamType|Int|2|X|Môn sát hạch:<br>3: Trong hình| ||StartTime|Instant|20|X|Thời gian bắt đầu sát hạch<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’| ||EndTime|Instant|20||Thời gian kết thúc kết thúc<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’| ||Result|Int|5|X|Điểm sát hạch| ||ImageData|String|||Ảnh học viên<br>Base64<br>Định dạng: JPEG, PNG| |**Dữ liệu trả**<br>**về**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|<br>**Bắt buộc**|**Mô tả**| |**Dữ liệu trả**<br>**về**|Code|Int|5|X|Mã thực thi lệnh|
...
|Thông số|Mô tả|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**URL**|api/v1/data/roadexam|api/v1/data/roadexam|api/v1/data/roadexam|api/v1/data/roadexam|api/v1/data/roadexam| |**Phương**<br>**thức**|POST|POST|POST|POST|POST| |**Mô tả**|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch trên đường|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch trên đường|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch trên đường|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch trên đường|API cho phép truyền dữ liệu từ máy chủ giám sát sát hạch của Trung tâm sát hạch tới<br>máy chủ sát hạch trên đường| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch| |**Dữ liệu đầu**<br>**vào**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|<br>**Bắt buộc**|**Mô tả**| ||ProviderId|String|20|X|Đơn vị cung cấp| ||TransactionCode|String|255|X|Mã giao dịch| ||DateSent|Date|20|X|Ngày gửi<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’<br>VD: 2024-01-01T00:00:00Z| ||Sender|String|255|X|Người gửi| ||TotalRecords|Int|5||Tổng số bản ghi| ||ExamCode|String|20|X|Mã kỳ sát hạch| ||ExamDate|Date|10|X|Ngày sát hạch<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| ||ExamTime|Int|4|X|Giờ sát hạch<br>Định dạng hhmm<br>VD: 730; 1400| ||DecisionNo|String|30||Số quyết định| ||DecisionDate|Date|10||Ngày quyết định<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| ||DecisionMaker|String|255||Người ra quyết định| ||BoardExaminers|List<BoardData>|||Danh sách hội đồng sát<br>hạch<br>Tham chiếu mục 2. Dữ liệu<br>hội đồng sát hạch| ||StudentData|List<StudentData>||X|Danh sách học viên dự sát<br>hạch<br>Tham chiếu mục 3. Dữ liệu<br>học viên dự sát hạch trên<br>đường| |**Dữ liệu trả**<br>**về**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|<br>**Bắt buộc**|**Mô tả**| |**Dữ liệu trả**<br>**về**|Code|Int|5|X|Mã thực thi lệnh|
...
|Col1|Col2|Col3|Col4|12: SH lại L+M+H+Đ<br>13: SH lại M+H+Đ<br>14: SH lại L+M| |---|---|---|---|---| |ExamType|String|5|X|Hạng sát hạch. Thuộc danh<br>mục:<br>+A1: Hạng A1<br>+ A: Hạng A<br>+ B1: Hạng B1<br>+ B: Hạng B<br>+ C1: Hạng C1<br>+ C: Hạng C<br>+ D2: Hạng D2<br>+ D1: Hạng D1<br>+ D: Hạng D<br>+ BE: Hạng BE<br>+ C1E: Hạng C1E<br>+ CE: Hạng CE<br>+ D2E: Hạng D2E<br>+ D1E: Hạng D1E<br>+ DE: Hạng DE| |ReasonExamination|String|255||Lý do sát hạch| |ImageData|String||X|Ảnh học viên Base64<br>Định dạng: JPEG, PNG| |ImageQuality|Int|2|X|Chất lượng ảnh:<br>- 1: true<br>- 0: false| |ContentNote|String|500||Ghi chú|
...
|Thông số|Mô tả|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**URL**|api/v1/data/roadresult|api/v1/data/roadresult|api/v1/data/roadresult|api/v1/data/roadresult|api/v1/data/roadresult| |**Phương**<br>**thức**|POST|POST|POST|POST|POST| |**Mô tả**|API cho phép cập nhật thông tin kết quả sát hạch trên đường từ phần mềm sát hạch<br>trên đường đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch trên đường từ phần mềm sát hạch<br>trên đường đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch trên đường từ phần mềm sát hạch<br>trên đường đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch trên đường từ phần mềm sát hạch<br>trên đường đến phần mềm giám sát sát hạch trung tâm sát hạch|API cho phép cập nhật thông tin kết quả sát hạch trên đường từ phần mềm sát hạch<br>trên đường đến phần mềm giám sát sát hạch trung tâm sát hạch| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp|Authorization Token (Được khởi tạo sau quá trình login)<br>ProviderId: Đơn vị cung cấp| |**Dữ liệu đầu**<br>**vào**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|<br>**Bắt buộc**|**Mô tả**| |**Dữ liệu đầu**<br>**vào**|CenterID|String|20|X|Mã trung tâm sát hạch| |**Dữ liệu đầu**<br>**vào**|DateSent|Date|20|X|Ngày gửi<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’<br>VD: 2024-01-<br>01T00:00:00Z| |**Dữ liệu đầu**<br>**vào**|StudentData|List<StudentData>||X|Danh sách học viên dự sát<br>hạch|

|Col1|StudentId|String|30|X|Mã đăng ký| |---|---|---|---|---|---| ||FullName|String|255|X|Họ và tên học viên| ||DateOfBirth|Date|10|X|Ngày sinh<br>Định dạng: yyyy-mm-dd<br>VD: 2024-01-01| ||CCCDID|String|50|X|CMND/ CCCD/ Hộ chiếu| ||RegistrationNo|String|30|X|Số báo danh| ||ExamType|String|5|X|Hạng sát hạch. Thuộc<br>danh mục:<br>+ A1: Hạng A1<br>+ A: Hạng A<br>+ B1: Hạng B1<br>+ B: Hạng B<br>+ C1: Hạng C1<br>+ C: Hạng C<br>+ D2: Hạng D2<br>+ D1: Hạng D1<br>+ D: Hạng D<br>+ BE: Hạng BE<br>+ C1E: Hạng C1E<br>+ CE: Hạng CE<br>+ D2E: Hạng D2E<br>+ D1E: Hạng D1E<br>+ DE: Hạng DE| ||ExamCode|String|20|X|Mã kỳ sát hạch| ||ExamType|Int|2|X|Môn sát hạch:<br>4: Trên đường| ||StartTime|Instant|20|X|Thời gian bắt đầu sát hạch<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’| ||EndTime|Instant|20||Thời gian kết thúc kết thúc<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’| ||Result|Int|5|X|Điểm sát hạch| ||ImageData|String|||Ảnh học viên<br>Base64<br>Định dạng: JPEG, PNG| |**Dữ liệu trả**<br>**về**|**Tên trường**|**Kiểu dữ liệu**|**Độ dài kí**<br>**tự**|<br>**Bắt buộc**|** Mô tả**| |**Dữ liệu trả**<br>**về**|Code|Int|5|X|Mã thực thi lệnh|

**4.8. Hàm kiểm tra trạng thái hệ thống**

|Thông số|Mô tả| |---|---| |**URL**|api/v1/server/getserverstatus| |**Phương thức**|POST| |**Mô tả**|API này cho phép lấy trạng thái hiện tại của hệ thống. Tùy trạng thái vận hành của hệ<br>thống thì hàm này sẽ trả về trạng thái hệ thống có sẵn sàng tiếp nhận dữ liệu hay|

|Col1|không.|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**Header**|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch| |**Dữ liệu đầu**<br>**vào**|**Tên trường**|**Kiểu dữ liệu**|**  Độ dài kí**<br>**tự**|**Bắt buộc**|**Mô tả**| |**Dữ liệu đầu**<br>**vào**|UserName|String|20|X<br>|Tên đăng nhập người dùng| |**Dữ liệu trả về**|**Tên trường**|**Kiểu dữ liệu**|**  Độ dài kí**<br>**tự**|**Bắt buộc**|**Mô tả**| ||State|Int|1|X<br> <br>|Trạng thái hiện tại của hệ<br>thống| ||StateMessage|String|255|X<br> <br>|Thông báo về trạng thái hiện<br>tại của hệ thống| ||NextUpdateTime|DateTime||X<br> <br><br> <br>|Thời gian có thông tin cập nhật<br>mới.<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’|
...
|Thông số|Mô tả|Col3|Col4|Col5|Col6| |---|---|---|---|---|---| |**URL**<br>|api/v1/server/getstatistic|api/v1/server/getstatistic|api/v1/server/getstatistic|api/v1/server/getstatistic|api/v1/server/getstatistic| |**Phương thức**|POST|POST|POST|POST|POST| |**Mô tả**<br>|API này cho phép lấy kết quả thống kê kết quả truyền dữ liệu của trung tâm sát hạch|API này cho phép lấy kết quả thống kê kết quả truyền dữ liệu của trung tâm sát hạch|API này cho phép lấy kết quả thống kê kết quả truyền dữ liệu của trung tâm sát hạch|API này cho phép lấy kết quả thống kê kết quả truyền dữ liệu của trung tâm sát hạch|API này cho phép lấy kết quả thống kê kết quả truyền dữ liệu của trung tâm sát hạch| |**Header**<br> <br>|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch|Authorization Token (Được khởi tạo sau quá trình login)<br>CenterID: Mã trung tâm sát hạch| |**Dữ liệu đầu**<br>**vào**<br><br><br>|**Tên trường**|**Kiểu dữ liệu**|**   Độ dài kí**<br>**tự**|**Bắt buộc**|**Mô tả**| |**Dữ liệu đầu**<br>**vào**<br><br><br>|ExamCode|String|20||Mã kỳ sát hạch| |**Dữ liệu đầu**<br>**vào**<br><br><br>|TimeFrom|Instant||X|Thời gian từ<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’| |**Dữ liệu đầu**<br>**vào**<br><br><br>|TimeTo|Instant||X|Thời gian đến (thời gian gian<br>không được quá 7 ngày từ<br>TimeFrom)<br>Định dạng: yyyy-mm-<br>dd’T’hh:mm:ss’Z’| |**Dữ liệu trả về**<br>|**   Tên trường**|**Kiểu dữ liệu**|**   Độ dài kí**<br>**tự**|**Bắt buộc**|**  Mô tả**| |**Dữ liệu trả về**<br>|NumberOfSuccess|Int|5|X|Tổng số phiên nhận thành<br>công trong khoảng thời gian<br>tương ứng với điều kiện truy<br>vấn. VD: Nếu chỉ truyền<br>CenterID thì hệ thống trả kết<br>quả số lượng các phiên truyền<br>thành công trong khoảng thời<br>gian yêu cầu. Nếu truyền<br>thêm các thông tin khác như<br>ExamCode thì hệ thống sẽ trả<br>về kết quả chi tiết theo điều<br>kiện truyền.|